...
I use Emacs and its literate programming features to generate
all the files in the =files= directory. So do not edit these
directly but work on this document instead. Then:
